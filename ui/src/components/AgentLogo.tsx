...
/** 官方 Claude logo 的星芒标记：viewBox 0 0 24 24 的实心路径，随 currentColor 着色。 */
const CLAUDE_MARK =
...
/** md=28px 列表/徽标默认，sm=24px 紧凑工具条，xs=18px 行内文字旁。 */
export type AgentLogoSize = 'md' | 'sm' | 'xs';

/** 小尺寸代理标识：claude 用官方星芒、codex 用终端框；名称由图标或相邻文字提供。 */
export function AgentLogo({
  ...
  return (
    <span
      class={`agent-logo agent-logo-${agent}${size === 'md' ? '' : ` agent-logo-${size}`}`}
      title={label}
